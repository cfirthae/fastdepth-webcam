...
This repo offers modifications for the [FastDepth](http://fastdepth.mit.edu/) project at MIT to run on Jetson Nano using RPi v2 camera video feed.
...
## Quick Start
For quick testing, run webcam.py with the arg '--evaluate best_result.pth.tar"
