...
def main():
	...
	#grid_width, grid_height = net.GetGridSize()
	   ...
	   #         class_mask = jetson.utils.cudaAllocMapped(width=640, height=480, format='gray8')
	  #          net.Mask(class_mask,640,480)
	...
	#class_mask = np.reshape(class_mask_np, [640,480])
	#print('mask shape is',class_mask.shape)
